          ...
          <v-card-text>
            <div class="info-box">
              <div class="info-text">
                ...
                <p class="info-text-p">
                  <span>Manager:&nbsp;</span>
                  I would like you to create a list of people with their
                  <strong>Titles</strong> &amp; <strong>Job Titles</strong>
                </p>
              </div>
    ...
    return new Promise((resolve, reject) => {
      clientApollo
        ...
        .then((resp) => {
          ...
          this.listingsGQL = resp.data.getJobTitles
          this.responseData = resp.data.getJobTitles
